...
('00001', 'iPhone X00011', 'Apple iPhone X1', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('2', 'iPhone X2', 'Apple iPhone X2', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('3', 'iPhone X3', 'Apple iPhone X3', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('4', 'iPhone X4', 'Apple iPhone X4', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('5', 'iPhone X1', 'Apple iPhone X5', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('6', 'iPhone X2', 'Apple iPhone X6', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('7', 'iPhone X3', 'Apple iPhone X7', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('8', 'iPhone X4', 'Apple iPhone X8', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('9', 'iPhone X4', 'Apple iPhone X9', '/img/iphonex.png', 'iPhone X', '8388.00', '10000'), 
('10', 'iPhone X5', 'Apple iPhone X5', '/img/iphonex.png', 'iPhone X', '8388.00', '10000');
...
BEGIN
	...
	set i=1;
	WHILE i<10 DO 
		INSERT INTO goods VALUES  (i, concat('iPhone', i), concat('Title iPhone', i), '/img/iphonex.png', concat('iPhone X', i), '8388.00', '10000');
		SET i=i+1; 
	END WHILE; 
	commit; 
END
...
set num=0; 
while num < 1000 do 
	insert into goods values(num, concat('iPhone', num) , concat('iPhone title', num) , '/img/iphonex.png', concat('iPhone detail', num),  8388.00, 10000);
	set num=num+1;
end while;
commit;
...
set num=0; 
while num < 1000 do 
	insert into miaosha_goods values(num, num, 0.01, 100, '2018-06-23 15:18:00', '2018-06-30 14:00:18');
	set num=num+1;
end while;
commit;
end
...
-- ----------------------------
BEGIN;
INSERT INTO `miaosha_order` VALUES ('16', '13910380055', '1', '16');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `order_info` VALUES ('16', '13910380055', '1', null, 'iPhone X', '1', '0.01', '1', '0', '2018-06-25 15:17:10', null);
COMMIT;
